            ...
            <Header/>
                <div className="container">
                    <figure className="image is-3by1">
                        <img src={require('../image/page-image/Seediq/Seediq.jpg').default } alt="Seediq"></img>
                    </figure>
                    <div className="section ">
                        <hr className="line"></hr>                         
                        <div className="columns is-align-items-center">
                            <div className="column">
                                <img className="is-256x256 image-center " src={require('../image/page-image/Seediq/icon.png').default }alt="賽德克族圖騰"></img>
                            </div>
                            <div className="column 	">
                        ...
                        <div className="columns">
                            <div className="column">
                                <figure className="image is-3by2 pic">
                                    <img  src={require('../image/page-image/Seediq/sowing.png').default }alt="播種祭"></img>
                                </figure>
                                <div className="subtitle has-text-centered">播種祭</div>
                            </div>
                            <div className="column ">
                                <figure className="image is-3by2 pic">
                                    <img className="image-center" src={require('../image/page-image/Seediq/reward.png').default }alt="收穫祭"></img>
                                </figure>
