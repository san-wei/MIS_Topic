            ...
            <Header/>
                <div className="container">
                    <figure className="image is-3by1">
                        <img src={require('../image/page-image/Puyuma/Puyuma.jpg').default } alt="Puyuma"></img>
                    </figure>
                    <div className="section ">
                        <hr className="line"></hr>                         
                        <div className="columns is-align-items-center">
                            <div className="column">
                                <img className="is-256x256 image-center " src={require('../image/page-image/Puyuma/icon.png').default }alt="卑南族圖騰"></img>
                            </div>
                            <div className="column 	">
                        ...
                        <div className="columns">
                            <div className="column">
                                <figure className="image is-3by2 pic">
                                    <img className="image-center" src={require('../image/page-image/Puyuma/swing.png').default }alt="小米收穫祭-盪鞦韆"></img>
                                </figure>
                                <div className="subtitle has-text-centered">除喪祭</div>
                            </div>
                            <div className="column ">
                                <figure className="image is-3by2 pic">
                                    <img className="image-center" src={require('../image/page-image/Puyuma/year.png').default }alt="年祭"></img>
                                </figure>
                                <div className="subtitle has-text-centered">大獵祭</div>
                            </div>
                            <div className="column ">
                                <figure className="image is-3by2 ">
                                    <img className="image-center" src={require('../image/page-image/Puyuma/mon.png').default }alt="猴祭"></img>
                                </figure>
                                <div className="subtitle has-text-centered">猴祭</div>
                            </div>
                            <div className="column ">
                                <figure className="image is-3by2 ">
                                    <img className="image-center" src={require('../image/page-image/Puyuma/river.png').default }alt="猴祭"></img>
                                </figure>
